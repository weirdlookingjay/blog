...
<div class="wrapper">
	...
	<div class="header-bottom flex fl-row">
		<div class="header-b-left fl-1">
			...
			<div>
<a href="http://<?php echo $blog->Domain;?>.localhost:84/corso/Blogger/" target="_blank">ViewBlog</a>
			</div>
		</div>
	...
	<div class="main-inner flex fl-1 fl-row ">
		...
		<div class="main-left-inner flex fl-c fl-1">
			<div class="main-menu fl-4">
				<ul>
					<li class="active"><span><i class="fa fa-newspaper"></i></span><a href="{BASE_URL}admin/blogID/{BLOG-ID}/dashboard/">Posts</a></li>
                <ul>
...
<li><span><i class="fa fa-chart-bar"></i></span>
...
<ul>
<li>
<a href="javascript:;" id="newLabel" data-blog="<?php echo $blog->blogID;?>">Nuova Etichetta...</a>
</li>
<?php
$dashObj->getLabelsMenu($blog->blogID);	?>
</ul>
</div>

<button id="publishBtn">Publish</button>
<button id="draftBtn">Revert to darft</button>
<button id="deleteBtn" style="margin: 2px;"><i class="fa fa-trash"></i></button>
					</div>
					</div>
				</div>
